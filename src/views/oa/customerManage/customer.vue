<script>
import * as api from "@/api/oa/customer";
import { getList as getListTag } from "@/api/oa/customer/tag";
import { getList as getListOrganization } from "@/api/oa/organization";
import { updateBirthday, getDetail } from '@/api/oa/customer'
...
export default {
  name: "Customer",
  components: { AddTag, SelectUser, SelectTag,CustomerDetail },
  props: {},
  data() {
    return {
      query: {
      ...
      dialogVisibleDetail:false,//查看客户详情弹窗显隐
  ...
  methods: {
    ...
    LookDetail(e){
      // console.log(e.externalUserid)
     this.getDetail(e.externalUserid)
