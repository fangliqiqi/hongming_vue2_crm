  ...
  <div class="app-container">
    ...
    <div>
      ...
      <div v-if="optionValue=='10'">
        <el-checkbox-group v-model="importListcheck" class="checkboxlist" >
          <el-checkbox :label="item" v-for="item in importList"></el-checkbox>
        </el-checkbox-group>
      </div>
      <!-- 导出商机 -->
      <div v-if="optionValue=='20'">
        <el-checkbox-group v-model="exportListcheck" class="checkboxlist" >
          <el-checkbox :label="item" v-for="item in exportList"></el-checkbox>
        </el-checkbox-group>
      </div>
      <!-- 删除商机 -->
      <div v-if="optionValue=='30'">
        <el-checkbox-group v-model="removeListcheck" class="checkboxlist" >
          <el-checkbox :label="item" v-for="item in removeList"></el-checkbox>
        </el-checkbox-group>
      </div>
    </div>
   </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        optionValue:'10',
        // 导入商机标签
        importList:['导入商机1','导入商机2','导入商机3'],
        // 导入商机选中
       importListcheck:[],
       // 导出商机来源
       exportList:['导出商机1','导出商机2','导出商机3'],
       // 导出商机来源  选中
       exportListcheck:[],
        // 删除商机
        removeList:['删除商机1','删除商机2','删除商机3'],
        // 删除商机选项
        removeListcheck:[],
        // 选项弹窗
        optionOpen:false,
