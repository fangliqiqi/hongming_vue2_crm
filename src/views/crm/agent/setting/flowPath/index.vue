<template>
  <div class="app-container flowPath">
    <!--  搜索框  -->
    <div class="search-vi">
      <el-row :gutter="24">
        <el-col :span="24">
    ...
    <div class="table-data">
      <div class="header_btn">
        <span style="margin-right: 30px;">成交流程</span>
         <el-switch
           v-model="swithvalue"
           active-color="#3978E7"
           >
         </el-switch>
         <span style="font-size: 12px;color:#565759;margin-left: 5px;">开启流程管理</span>
     </div>
      <!-- 流程页面 -->
      <div  class="step">
         ...
         <el-step>
           <template slot="title">
             <div class="title_wrap" >
               <span class="left">开始转成交</span>
               <span class="right" >商机如果跟进成功，则需要转成交</span>
             </div>
           </template>
         </el-step>
         <el-step title="客户信息补全">
           <template slot="title">
             <div class="title_wrap">
               <span class="left">客户信息补齐</span>
               <span class="right">
                 <span>需要先补充客户信息，可设置必填项</span>
                  <el-checkbox-group v-model='cusList' style="padding-top: 16px;width: 50%;">
                      <el-checkbox label="1" disabled>联系方式</el-checkbox>
                      <el-checkbox label="2" disabled>客户类型</el-checkbox>
                      <el-checkbox label="3" disabled>增值税</el-checkbox>
                      <el-checkbox label="4" >行业分类</el-checkbox>
                      <el-checkbox label="5" >在其他公司代过账</el-checkbox>
                      <el-checkbox label="6" >详细地址</el-checkbox>
                      <el-checkbox label="7" >行业分类</el-checkbox>
                      <el-checkbox label="8" >在其他公司代过账</el-checkbox>
                  </el-checkbox-group>
               </span>
             </div>
           </template>
         </el-step>
         <el-step title="创建合同获订单" >
           <template slot="title">
             <div class="title_wrap">
               <span class="left">创建合同或订单</span>
               <span class="right">开启后，必须创建合同或订单，才能转成交</span>
             </div>
           </template>
         </el-step>
          <el-step title="已成交">
            <template slot="title">
              <div class="title_wrap">
                <span class="left">已成交</span>
                <span class="right">商机成功转为客户</span>
              </div>
            </template>
          </el-step>
       </el-steps>
