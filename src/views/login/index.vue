  ...
  <div class="login_vi">
    <el-row type="flex">
      <el-col :span="11" :xs="24" class="login_left" >
        <img class="logo" :src="require('@/assets/image/login_logo2.png')">
      </el-col>
      <el-col :span="13" :xs="24" class="login_right">
            ...
            <el-tab-pane label="密码登录" name="10">
              <el-form ref="loginForm" :model="loginForm" :rules="loginRules" >
                <el-form-item prop="username">
                  <el-input v-model.trim="loginForm.username" type="text" auto-complete="off" placeholder="账号/手机号"  size="default">
                ...
                <el-form-item prop="piccode">
                  <el-input
                    v-model.trim="loginForm.piccode"
                    auto-complete="off"
                    placeholder="验证码"
                    style="width: 100%"
                ...
                <el-form-item style="width:100%;">
                 ...
                 <div class="noAccount">
                  <span>没有账号？<el-button type="text" @click="apply">立即申请</el-button></span>
                  <span><el-button type="text" @click="forgot">忘记密码？</el-button></span>
                  </div>
              </el-form>
            </el-tab-pane>
            <el-tab-pane label="验证码登录" name="20">
              <el-form ref="msgLoginForm" :model="loginForm" :rules="msgLoginRules" >
                <el-form-item prop="phoneNumbers">
                  <el-input v-model.trim="loginForm.phoneNumbers"   type="text" auto-complete="off" placeholder="手机号码"
                            size="default">
                  </el-input>
                </el-form-item>
                ...
                <div class="noAccount">
                  <span>没有账号？<el-button type="text" @click="apply">立即注册</el-button></span>
                  <span><el-button type="text" @click="forgot">忘记密码？</el-button></span>
                  </div>
              </el-form>
            </el-tab-pane>
        ...
        <div class="el-login-footer">
          <span>Copyright © 2018-2020 www.modewenti.com 安徽泓铭网络科技有限公司</span>
           <span style="display:block;font-size:14px"><a href="https://beian.miit.gov.cn/" target="_blank">皖ICP备2021001851号</a></span>
        </div>
      </el-col>
    </el-row>
  </div>
