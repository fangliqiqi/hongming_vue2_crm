...
export function getContracRecordtList(query) {
    return request({
        url: "/hmkj-crm/marketCompanyEssential/selectContract",
        method: "get",
        params: query
    });
}
//合同详情
export function getContracRecordtDetail(query) {
    return request({
        url: "/hmkj-crm/marketCompanyEssential//selectContract",
        method: "get",
        params: query
...
export function changeContact(data) {
    return request({
        url: "/hmkj-crm/marketCompanyEssential/primaryContact",
        method: "post",
        data: data
    });
}
...
export function exportCustomerData(data) {
    return request({
        url: '/hmkj-crm/marketCompanyBusirUrgeReview/orderExport',
        method: 'post',
        data: data,
    })
}
// 关联云帐房
export function createQy(data) {
    return request({
        url: '/hmkj-crm/yzfInterface/createQy',
        method: 'post',
        data: data,
    })
}